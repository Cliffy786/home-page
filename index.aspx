<html class="js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths fa-events-icons-ready"><head>
    ...
    <title>Index - Posworx online shop</title>
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-left" href="/">
                        <img src="../Images/posworx-logo-small.jpg" alt="Posworx logo">
                    </a>
                </div>
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="btn-header"><a data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-user"></span>&nbsp;Log in</a></li>
                        <li class="btn-header"><a href="/Pages/GiftCardDataPage.aspx"><span class="glyphicon glyphicon-gift"></span>&nbsp;Wish List</a></li>
                        <li class="btn-header"><a href="/Pages/LoyaltyCardDataPage.aspx"><span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;Cart</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-left" style="letter-spacing:1.3px;color:#ffffff">
                            <li><a style="color:#ffffff;" href="#">&nbsp;Women</a></li>
                            <li><a style="color:#ffffff;" href="/Pages/GiftCardDataPage.aspx">&nbsp;Men</a></li>
                            <li><a style="color:#ffffff;" href="/Pages/LoyaltyCardDataPage.aspx">&nbsp;Kids</a></li>
                            <li><a style="color:#ffffff;" href="/Pages/LoyaltyCardDataPage.aspx">&nbsp;Home</a></li>
                            <li><a style="color:#ffffff;" href="/Pages/LoyaltyCardDataPage.aspx">&nbsp;Brands</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div class="home-page-image center-text" style="background-image: url(../../Images/venice-beach-cali.PNG)">
    <div class="padding-top-hundred padding-bottom-hundred">
        <div>
            ...
            <h2 class="white-strong-text header-section-spacing">Experience effortless.</h2>
            <h3 class="white-strong-text">Innovative shopping defined.</h3>
        </div>
        <div class="container-fluid">
            <div class="big-margin-top">
                <button class="previous btn btn-default btn- btn-lg"><b>Start Shopping</b></button>
            </div>
        </div>
    </div>
</div>
...
<div class="container small-margin-top">
    <div class="row">
        <div class="col-md-12">
            ...
            <h2>Indulge In Online Fashion With Posworx</h2>
            <p>
            ...
            <h2>Stay On-Trend With Apparel For Men, Women And Children Online</h2>

            <p>
                Your every fashion dream comes true with Posworx’s trendy clothing for ladies, men and children.
                ...
                Browse our Fashion Glossary and find trendy clothing items and shoes.
            </p>

            <h2>Step Out In Style With Shoes Online At Posworx</h2>

            <p>
                Make sure your shoe-game is up to standard with Posworx’s wide selection of shoes.
                ...
                Kiddies are not left out of the fashionable footwear equation! Buy children’s shoes from basic school shoes, to casual sneakers, boots, sandals and more, Posworx has not forgotten about the tiniest feet in the family and all your family’s footwear needs are taken care of in a few simple clicks!
            </p>
                ...
                <footer>
                    ...
                    <div class="col-md-3">
                        <div>
                            ...
                            <ul class="footer-lists">
                                <li><a class="page-footer-icons"><i class="fa fa-twitter" aria-hidden="true"></i> twitter</a></li>
                            </ul>
                        </div>
                    </div>
...
<script type="application/json" id="__browserLink_initializationData">
    {"appName":"Chrome","requestId":"9ab2f6665127410a992fc067ce0d6024"}
</script>
<script type="text/javascript" src="http://localhost:50984/bbfba8cff723498da7f52c390c7a8f94/browserLink" async="async"></script>
<!-- End Browser Link -->
</body>
</html>
